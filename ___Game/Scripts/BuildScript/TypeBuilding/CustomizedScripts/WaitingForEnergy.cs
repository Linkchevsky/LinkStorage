...
public class WaitingForEnergy : MonoCache, BuildingInterface
{
    ...
    public void InstallationOfWires(List<GameObject> listOfBuildingsGO, List<Collider2D> notAddedInList) => throw new ArgumentException("У заготовки не может быть связи с сетью!");
