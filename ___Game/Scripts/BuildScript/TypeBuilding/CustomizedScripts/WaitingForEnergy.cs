...
public class WaitingForEnergy : MonoCache, BuildingInterface
{
    ...
    public void InstallationOfWires(List<GameObject> listOfBuildingsGO, bool theWireUsed = false) => throw new ArgumentException("У заготовки не может быть связи с сетью!");
